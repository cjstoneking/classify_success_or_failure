...
training_positive_texts = {
  ...
  "We lost all our money":0,\ #start self-generated here
  ...
  "No one wanted it":0,\
  "No one wanted to buy it":0,\
  "No one was interested":0,\
  "No one cared":0,\
  "No one wanted to try it":0,\
  "No one liked it":0,\
  "We couldn't find a market niche":0,\
  "We lost confidence":0,\
  "He ran out of ideas":0,\
  "It failed to take off":0,\
  ...
  "Everyone hated it":0,\
  "It was a train wreck":0,\
  "It was a disaster":0,\
  "It was a mess":0,\
  "It was nothing but trouble":0,\
  "We made so many mistakes":0,\
  "We just couldn't do it":0,\
  "He just couldn't do it":0,\
  "It did not work":0,\
  "The project did not work":0,\
  "The demo failed":0,\
  "The demo did not impress anyone":0,\
  "The demo did not convince anyone":0,\
  "It was a massive disappointment":0,\
  "Too many mistakes":0,\
  "A big step backwards":0,\
  "A lot of problems":0,\
  "A lot of setbacks":0,\
  "We had negative press":0,\
  "We lacked the expertise":0,\
  "We lacked the money":0,\
  "We lacked the funding":0,\
  "We burned out":0,\
  "Everyone burned out":0,\
  "It crashed":0,\
  "They ran into more and more problems":0,\
  "We made a serious mistake":0,\
  "We were wrong about that":0\
